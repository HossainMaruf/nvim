...
keymap("n", "]d", vim.diagnostic.goto_next) -- Go to next error
keymap("n", "[d", vim.diagnostic.goto_prev) -- Go to previous error
...
-- ============================ VIMGREP START =================================
keymap("n", "<leader>nn", ":cnext<CR>") -- jump to the next match
keymap("n", "<leader>np", ":cprevious<CR>") -- jump to the previous match
keymap("n", "<leader>no", ":copen<CR>") -- open a window containing the list of matches
keymap("n", "<leader>nl", ":cclose<CR>") -- close the quickfix window
-- ============================ VIMGREP END =================================
...
keymap("n", "<leader>fr", ":Telescope registers<CR>")
keymap("n", "<leader>fs", ":Telescope lsp_document_symbols<CR>")
keymap("n", "<leader>fc", ":Telescope lsp_incoming_calls<CR>")
keymap("n", "<leader>fo", ":Telescope lsp_outgoing_calls<CR>")
